...
Release:    1%{?dist}
Group:      Qt/Qt
License:    LGPLv31 with exception
URL:        https://www.qt.io/
...
Group:      Qt/Qt
Requires:   %{name} = %{version}-%{release}
Requires:   %{name}-qtpacketprotocol = %{version}-%{release}

%description qtpacketprotocol-devel
This package contains the development headers for QtPacketProtocol
QML support library

%package qtqmldebug-devel
Summary:    Qt Declarative - QtQmlDebug library
Group:      Qt/Qt
Requires:   %{name}-devel = %{version}-%{release}

%description qtqmldebug-devel
This package contains the QtQmlDebug QML support library
...
This package provides the QtQuick Layouts plugin.

%package import-sharedimage
Summary:    Qt Declarative shared image plugin
Group:      Qt/Qt
Requires:   %{name} = %{version}-%{release}

%description import-sharedimage
This package provides the Qt Labs shared image plugin.
...
%package tool-qmlcachegen
Summary:    QML cachegen
Group:      Qt/Qt
Requires:   %{name} = %{version}-%{release}

%description tool-qmlcachegen
This package contains the %{summary} tool
...
%post qtpacketprotocol
/sbin/ldconfig
%postun qtpacketprotocol
/sbin/ldconfig
